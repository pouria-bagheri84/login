...
<body>
    ...
    <main class="w-50 m-auto">
        <form action="index.php" method="POST" class="mt-5 pt-5 row align-item-center justify-content-center needs-validation" novalidate>
            <h1 class="text-center">Sign in!</h1>
            <div class="mb-3 col-lg-6">
                <label for="exampleInputUsername1" class="form-label">Username</label>
                <input type="text" name="frm[username]" class="form-control" id="exampleInputUsername1" required>
            ...
            <div class="mb-3 form-check col-lg-6 text-center">
                <button type="submit" name="sub" class="btn btn-primary btn-sm col-lg-4">Submit</button>
            </div>
